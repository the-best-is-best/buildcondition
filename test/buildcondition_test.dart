...
void main() {
  testWidgets('Renders builder if `condition` is `true`',
      (WidgetTester tester) async {
    final renderedContainer = Container();
    await tester.pumpWidget(BuildCondition(
      condition: true,
  ...
  testWidgets('Renders `fallback` if `condition is `false`',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'Renders empty `Container` if `condition is `false` and `fallback` is null',
      (WidgetTester tester) async {
    final notRenderedContainer = Container();
    await tester.pumpWidget(BuildCondition(
      condition: false,
